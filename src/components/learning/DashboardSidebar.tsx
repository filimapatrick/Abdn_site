...
export default function DashboardSidebar({
  ...
  return (
    <aside className="w-64 bg-stone-950 border-r border-stone-800 flex flex-col justify-between flex-shrink-0 h-full overflow-y-auto">
      
      {/* Top Part: Navigation */}
      <div className="p-4 space-y-6">
        
        {/* Workspace Brand / Header */}
        <div className="px-3 py-2 rounded-2xl bg-stone-900/90 border border-stone-800/80">
        ...
        <div className="space-y-1">
          <div className="px-3 text-[10px] font-mono font-bold uppercase tracking-wider text-stone-500 pb-1">
            Workspace Nav
          </div>
            ...
            if (isDisabled) {
              return (
                ...
                >
                  ...
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-md bg-stone-900 text-stone-500 border border-stone-800/60">
                    Soon
                  </span>
                </div>
              );
        ...
        <div className="p-3.5 rounded-2xl bg-gradient-to-br from-stone-900 to-stone-900/60 border border-stone-800 space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="font-semibold text-stone-200 flex items-center space-x-1.5">
              <Flame className="w-4 h-4 text-amber-500 fill-amber-500" />
              <span>Learning Streak</span>
            </span>
            <span className="text-amber-400 font-mono font-bold">{streakDays} Days</span>
          </div>
          <div className="h-1.5 w-full bg-stone-950 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-amber-500 to-amber-400 rounded-full w-4/5" />
          </div>
      ...
      <div className="p-4 border-t border-stone-800/80 space-y-2">
        ...
        <Link
          to="/network/learning"
          className="mt-2 w-full px-3 py-2 rounded-xl bg-stone-900 hover:bg-stone-800 text-stone-400 hover:text-amber-300 text-xs flex items-center justify-between transition-colors border border-stone-800"
        >
        ...
        <button
          ...
          className="w-full px-3 py-2 rounded-xl text-stone-400 hover:text-rose-400 hover:bg-rose-950/20 text-xs flex items-center space-x-3 transition-colors"
        >
