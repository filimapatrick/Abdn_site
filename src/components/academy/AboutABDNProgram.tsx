...
const AboutABDNProgram = () => {
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-brown-100 via-brown-200 to-brown-50 text-brown-900">
...
export default AboutABDNProgram;
