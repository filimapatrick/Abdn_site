...
| **Paper 6** | **AI & Data Sovereignty** | *How can Socratic AI mentorship and automated CARE data sovereignty guardrails bridge the regional faculty shortage while protecting African biological data integrity in computational neuroscience training?* | Demonstrates an ethically governed, Socratic AI learning architecture that scales mentorship while embedding CARE Data Sovereignty. | *Nature Machine Intelligence*, *Lancet Digital Health* |
